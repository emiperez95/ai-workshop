...
async function main() {
  ...
  const articles = await Promise.all([
    prisma.article.create({
      data: {
        ...
        description:
          "A practical look at how TypeScript catches bugs before they reach production.",
        ...
        tagList: {
          connectOrCreate: [
            {
              where: { tagName: "programming" },
              create: { tagName: "programming" },
            },
            {
    ...
    prisma.article.create({
      data: {
        ...
        description:
          "Lessons from building APIs that people want to integrate with.",
    ...
    prisma.article.create({
      data: {
        ...
        description:
          "Why SQLite might be the right database for your next project.",
        ...
        tagList: {
          connectOrCreate: [
            {
              where: { tagName: "databases" },
              create: { tagName: "databases" },
            },
            {
              where: { tagName: "programming" },
              create: { tagName: "programming" },
    ...
    prisma.article.create({
      data: {
        ...
        description:
          "Moving from flexbox-everything to intentional grid layouts.",
    ...
    prisma.article.create({
      data: {
        ...
        description:
          "How better PR descriptions lead to faster reviews and fewer bugs.",
    ...
    prisma.article.create({
      data: {
        ...
        description:
          "Starting small with shared components and tokens pays off fast.",
    ...
    prisma.article.create({
      data: {
        ...
        description:
          "Strategies for evolving your database schema safely in production.",
    ...
    prisma.article.create({
      data: {
        ...
        description:
          "A systematic framework for finding and fixing bugs under pressure.",
    ...
    prisma.article.create({
      data: {
        ...
        description:
          "Practical accessibility patterns for web forms that benefit everyone.",
  ...
  await prisma.user.update({
    where: { username: "jake" },
    data: {
      follows: { connect: [{ username: "sarah" }, { username: "mike" }] },
    },
  });
  await prisma.user.update({
  ...
  await prisma.user.update({
    where: { username: "mike" },
    data: {
      follows: { connect: [{ username: "jake" }, { username: "anna" }] },
    },
  });
  await prisma.user.update({
    where: { username: "anna" },
    data: {
      follows: { connect: [{ username: "sarah" }, { username: "jake" }] },
    },
  });
    ...
    data: {
      favorites: {
        connect: [
          ...
          { slug: articles[6].slug },
          { slug: articles[9].slug },
        ],
      },
    },
  });
  ...
  await prisma.user.update({
    ...
    data: {
      favorites: {
        connect: [
          { slug: articles[1].slug },
          { slug: articles[5].slug },
          { slug: articles[8].slug },
        ],
      },
    },
  });
  ...
  await prisma.bookmark.create({
    data: { username: jake.username, articleSlug: articles[2].slug },
  });
  await prisma.bookmark.create({
    data: { username: jake.username, articleSlug: articles[8].slug },
  });
  await prisma.bookmark.create({
    data: { username: sarah.username, articleSlug: articles[0].slug },
  });
  await prisma.bookmark.create({
    data: { username: sarah.username, articleSlug: articles[3].slug },
  });
  await prisma.bookmark.create({
    data: { username: sarah.username, articleSlug: articles[7].slug },
  });
  await prisma.bookmark.create({
    data: { username: mike.username, articleSlug: articles[1].slug },
  });
  await prisma.bookmark.create({
    data: { username: mike.username, articleSlug: articles[4].slug },
  });
  await prisma.bookmark.create({
    data: { username: anna.username, articleSlug: articles[6].slug },
  });
  await prisma.bookmark.create({
    data: { username: anna.username, articleSlug: articles[2].slug },
  });

  console.log("Created bookmark relationships.");
